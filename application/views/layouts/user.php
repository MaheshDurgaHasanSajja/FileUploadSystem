...
<html>
    ...
    <body>
    	<div class="topnav">
		  <a class="active yes-no-alert pull-right" data-href="<?php echo base_url(); ?>user/login/logout" data-confirm-text='Are you sure to logout?'>Logout</a>
		</div>
        <div class="sidenav">
          <a href="javascript:void(0);" style="color:#fff;"><?php echo (isset($this->session->userdata['user_session']['name']) && $this->session->userdata['user_session']['name'] != "")?$this->session->userdata['user_session']['name']:"Admin"; ?></a>
		  <a class="<?php echo ($this->uri->segment(2) != "" && $this->uri->segment(2) == "dashboard")?'active':''; ?> left-menu" href="<?php echo base_url(); ?>user/dashboard">Dahboard</a>
		</div>
