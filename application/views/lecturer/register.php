    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4 well">
                <?php
                echo form_open(base_url("lecturer/register"), array("id" => "lecturer_register_form", "name" => "lecturer_register_form"));
                ?>
                <fieldset>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4 text-center" style="padding-bottom: 30px;">  
                Already Registered? <a href="<?php echo base_url() ?>lecturer/login">Login Here</a>
            </div>
        </div>
    </div>
