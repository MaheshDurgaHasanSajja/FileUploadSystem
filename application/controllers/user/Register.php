...
class Register extends CI_Controller {
        ...
        if (count($post_data) > 0) {
            if ($this->form_validation->run('register_form') == false) {
                ...
                $insert_data = array(
                    ...
                    "semister_id" => json_encode($post_data['semister_id']),
                    "subject_id" => json_encode($post_data['subject_id']),
                    "year" => json_encode($post_data['year']),
    ...
    */
    public function check_register_email_exists_or_not($str) {
        ...
        $where_array = array('email' => $_POST['email'], 'user_type' => 'S', "row_status" => 1);
